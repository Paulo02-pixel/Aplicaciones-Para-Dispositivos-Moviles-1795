...
En PolarNet, la gestión de configuración asegura un desarrollo ordenado, consistente y colaborativo. Esto garantiza que todos los cambios en el código, entornos y versiones del software estén controlados, lo que facilita la coordinación del equipo, la trazabilidad de las modificaciones y la entrega estable de la plataforma de gestión agrícola.
...
Para esta fase, se implementaron soluciones que facilitan recoleccion y organizacion de los requisitos del proyecto. Se utilizo Trello para gestion de tareas, UXPressia para el desarrolllo de user personas y Miro para los scenarios
* Trello
* Uxpressia
* Miro
...
El equipo utilizo Figma para la creacion de wireframes, mockups y prototipos interactivos.
* Figma
  

#### Software Development 

Para el desarrollo de la landing page se usaron lenguajes Html, Css y JavaScript en visual studio code. La elaboracion del informe se hizo en un archivo .md y el desarrollo de la aplicacion web se hizo en android studio.
* Visual Studio Code
* Android Studio

#### Software Architecture Diagrams 

Structurizr: Herramienta para modelar la arquitectura con C4 (Context, Container, Component, Code). Se emplea para visualizar flujos. 

### 4.1.2 Source Code Management

En PolarNet, el control de versiones se gestiona con GitHub siguiendo el flujo GitFlow: 

Main: Rama principal con código estable y listo para despliegue.


Dev: Rama de desarrollo activo, donde se integran funcionalidades. 

Deployment: Rama intermedia para preparar versiones candidatas, ejecutar pruebas finales y validar entregas. 

Feature branches: Por cada nueva funcionalidad, se crean ramas independientes desde dev. 

Este enfoque garantiza un desarrollo limpio, colaborativo y con control de versiones progresivo. 

### 4.1.3 Source Code Style Guide & Conventions
#### Nomenclatura General 

* Clases, servicios y componentes en PascalCase. 

* Métodos y variables en camelCase. 

* Nombres claros y descriptivos para entidades. 
...
* Cada bloque funcional con su jerarquía clara para favorecer la legibilidad. 

  

#### Especificaciones Generales 

* Funciones organizadas y comentadas solo cuando sea estrictamente necesario. 

* Propiedades opcionales con valores por defecto para evitar errores en tiempo de ejecución. 

* Manejo de errores mediante excepciones específicas en procesos. 

* Separación estricta entre lógica de presentación (frontend) y lógica de negocio (backend). 

### 4.1.4 Deployment Configuration

#### Landing page deployment:
Para desplegar la landing page, es necesario cumplir con ciertos requisitos previos, como contar con una cuenta personal, una organización y un repositorio donde se
alojarán los archivos. Una vez cumplidos estos requisitos, se pueden seguir los pasos detallados a continuación para realizar el despliegue:
1. Verificar que los archivos principales se encuentren en la raíz (root) del repositorio.
2. Asegurarse de que los archivos sigan las siguientes convenciones de nombres: "index.html" para la página principal, "styles.css" para los estilos, "script.js" para los
scripts principales, "languages.js" para gestionar los textos en diferentes idiomas (español e inglés), y una carpeta llamada "assets/images" para las imágenes.
...
6. Esperar a que GitHub realice las verificaciones necesarias. Una vez finalizado el proceso, se generará un enlace que permitirá acceder a la landing page
desplegada.
